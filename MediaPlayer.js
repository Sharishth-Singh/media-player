  ...
  return (
    <div className={`media-player ${isMinimized ? 'minimized' : ''}`}>
      <div className="media-controls">
        ...
        <button onClick={nextMedia}><FaChevronRight /></button>
        <button onClick={skipBackward}><FaFastBackward /></button>
        <button onClick={skipForward}><FaFastForward /></button>
        ...
        <button onClick={toggleMinimize}><FaTimes /></button>
        <input
          type="range"
          min="0.5"
          max="4"
